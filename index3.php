...
<?php include 'banner.php'; ?>
    ...
    <!-- Testimonial 4 start -->
    <div class="testimonial-4 content-area-5 bg-grea-3" style="background: #648fd666">
        <div class="container">
            <!-- Main title -->
    ...
    <!-- Our team 2 start -->
    <div class="our-team-2 content-area" style="background: #648fd62e">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
    ...
    <div class="featured-properties content-area-9 " style="background: #648fd666">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
