                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="index4.php">Home 5</a></li>
                            <li><a class="dropdown-item" href="index6.php">Home 6</a></li>
                            <!-- <li><a class="dropdown-item" href="index3.php">Home 4</a></li> -->
...
<div class="js-parallax parallax"
     data-img="img/pexels-simon-berger-1693302.jpg" data-parallax="scroll">
...
<!-- Our team 2 start -->
<div class="js-parallax parallax" data-img="img/pexels-simon-berger-1693302.jpg" data-parallax="scroll">
