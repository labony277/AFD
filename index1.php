...
<?php include 'banner.php'; ?>
    ...
    <!-- Testimonial 4 start -->
    <div class="testimonial-4 content-area-5 bg-grea-3" style="background: #34017e61">
        <div class="container">
            <!-- Main title -->
    ...
    <!-- Our team 2 start -->
    <div class="our-team-2 content-area" style="background: #34017e26">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInLeft delay-04s">
                    <div class="team-1">
                        <div class="team-photo">
                            <a href="list-view-3.html">
                                <img src="img/avatar/1n.jpg" alt="agent-2" class="img-fluid">
                            </a>

                        </div>
                        <div class="team-details">
                            <h5><a href="list-view-3.html">TRI SERVICE INSTITUTION</a></h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInLeft delay-04s">
                    <div class="team-1">
                        ...
                        <div class="team-details">
                            <h5><a href="list-view-3.html">BANGLADESH ARMY</a></h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInRight delay-04s">
                    <div class="team-1">
                        ...
                        <div class="team-details">
                            <h5><a href="list-view-3.html">BANGLADESH NAVY</a></h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInRight delay-04s">
                    <div class="team-1">
                        ...
                        <div class="team-details">
                            <h5><a href="list-view-3.html">BANGLADESH AIR FORCE</a></h5>
    ...
    <div class="featured-properties content-area-9" style="background: #34017e61">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
