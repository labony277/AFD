    ...
    <div class="container">
        ...
        <div class="single-team-member services-box">
            ...
            <div class="member-content">
                ...
                <br>
                <div class="others-options">
                    <a href="bangladesh_army/ecsme.php" class="btn btn-primary">Read More</a>
                </div>
            </div>
        </div>
   ...
   <!-- stc -->
        <div class="single-team-member services-box">
            ...
            <div class="member-content">
                ...
                <br>
                <div class="others-options">
                    <a href="bangladesh_army/stc.php" class="btn btn-primary">Read More</a>
                </div>
            </div>
        </div>
        <!-- sit -->
        <div class="single-team-member services-box">
            <div class="member-image">
                <a href="bangladesh_army/sit.php"><img src="assets/img/school/BA/6. SI&T/1. First Pic (Double Page).JPG" alt="image"></a>
            </div>
            <div class="member-content">
                ...
                <br>
                <div class="others-options">
                    <a href="bangladesh_army/sit.php" class="btn btn-primary">Read More</a>
                </div>
            </div>
        </div>
       <!-- ascc -->
        <div class="single-team-member services-box">
            <div class="member-image">
                <a href="bangladesh_army/asccs.php"><img src="assets/img/school/BA/7.  ASCC&S/1. First Pic (Double Page).jpg" alt="image"></a>
            </div>
            <div class="member-content">
                <h3>ARMY SERVICE CORPS CENTRE AND SCHOOL (ASCC&S)</h3>
                ...
                <br>
                <div class="others-options">
                    <a href="bangladesh_army/asccs.php" class="btn btn-primary">Read More</a>
                </div>
            </div>
        </div>
        <!-- oc&s -->
