                ...
                <div class="col-md-7 col-lg-12">
                    <div id="carouselExampleControls" class="carousel slide
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item" style="height: 500px">
                                <img class="d-block w-100"
                                    src="../assets/img/school/Bangladesh Navy/5.signal school/resize/4.jpg"
                                    alt="Third slide">
                            </div>
                        </div>
                              ...
                              <div class="col-md-12">
                                 <div class="row">
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/1.jpg" >
                                          <img src="../assets/img/school/Bangladesh Navy/5.signal school/resize/1.jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/2.jpg" >
                                          <img src="../assets/img/school/Bangladesh Navy/5.signal school/resize/2.jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/3.jpg">
                                          <img src="../assets/img/school/Bangladesh Navy/5.signal school/resize/3.jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/4.jpg">
                                          <img src="../assets/img/school/Bangladesh Navy/5.signal school/resize/4.jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/5.jpg">
                                          <img src="../assets/img/school/Bangladesh Navy/5.signal school/resize/5.jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/Bangladesh Navy/5.signal school/resize/1.jpg">
