...
<div class="page-title-area">
    <div class="page-title-content">
        <div class="row justify-content-center">
            ...
            <div class="col-10">
                <h2 class="details_header">ARMOURED CORPS CENTRE AND SCHOOL (ACC & S)</h2>
            </div>
        </div>
                        ...
                        <div class="p-4 border-top desc_box">
                            ...
                            <ul class="list-unstyled mt-3">
                                <li class="d-sm-flex align-items-center
                                    border-bottom pb-3
                                    mb-3">
                                    <p class="mr-4 lead">1. To Train and educate young officers, Junior
                                        Commissioned Officers and Non-Commissioned
                                        officers of Armoured Corps on developing
                                        technical, tactical, administration and leadership
                                        skils required to perform as effective junior leaders
                                        staff and instructors in Armoured Units inéombined!
                                        arms environment during war anid peace.</p>
                                </li>
                                <li class="d-sm-flex align-items-center
                                    border-bottom pb-3
                                    mb-3">
                                ...
                                <li class="d-sm-flex align-items-center
                                    border-bottom pb-3
                                    mb-3">
                                    <p class="mr-4 lead">3. To provide necessary technical and tactical
                                        training required for combined arms
                                        environment to officers, Junior Commissioned
                                        Officer and Other Ranks of Armoured Corps and
                                        Mechanized Forces.</p>
                                </li>
                            </ul>
                        </div>
