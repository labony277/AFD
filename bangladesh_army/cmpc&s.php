            ...
            <div class="col-md-12 col-lg-8">
               <div class="border mb-4">
                  ...
                  <div class="p-4 border-top desc_box">
                     <span class="lead fw-6">Objectives of CMPC8&S are as follow:</span>
                              ...
                              <div class="col-md-12">
                                 <div class="row">
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/1. First Pic (Double Page)-min.JPG" >
                                          <img src="../assets/img/school/BA/10. CMPC&S. Correction need/1. First Pic (Double Page)-min.JPG" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/2 .jpg" >
                                          <img src="../assets/img/school/BA/10. CMPC&S. Correction need/2 .jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/3 -min.JPG">
                                          <img src="../assets/img/school/BA/10. CMPC&S. Correction need/3 -min.JPG" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/4 .jpg">
                                          <img src="../assets/img/school/BA/10. CMPC&S. Correction need/4 .jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/5 .jpg">
                                          <img src="../assets/img/school/BA/10. CMPC&S. Correction need/5 .jpg" alt="" />
                                       </a>
                                    </div>
                                    <div class="col-md-6 m-0 p-1">
                                       <a title="The Cleaner" class="example-image-link" href="../assets/img/school/BA/10. CMPC&S. Correction need/1. First Pic (Double Page)-min.JPG">
                           ...
                           <table style="width:100%">
                              ...
                              <tr style="text-align: center;">
                                 ...
                                 <td>To provide selected officers with the basic special
                                    knowledge and skill to carry out the function of Military
                                    Police officer.
                                 </td>
                                 <td>English</td>
                                 <td>Captain/Major
