                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/navy/bna/1.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/navy/bna/2.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/navy/bna/3.jpg" alt="Third slide">
                        </div>
                    </div>
                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="border mb-4">
                        ...
                        <div class="p-4 border-top">
                            <p class="mt-2 lead ">The Bangladesh Naval Academy is situated at the mouth of the Karnaphuli River at Patenga, Chittagong District,
                                Bangladesh. Bathed by the river Karnaphuli on the east and sheltered on the south by the Bay of Bengal, BNA stands in a
                                panoramic natural picturesque in an isolated landscape of the country</p>
                        </div>
                    </div>
                    <!-- end -->
                    ...
                    mb-3">
                                    ...
                                    <p class="mr-4 lead ">1. To develop qualities, personal standard and
                                        conduct required of a naval Officer.</p>
                    ...
                    mb-3">
                                    ...
                                    <p class="mr-4 lead ">2. To impart basic professional knowledge to
                                        prepare Officer Cadets for next stage of
                                        training.</p>
                                </li>
                                <li class="d-sm-flex align-items-center border-bottom pb-3
                    mb-3">

                                    <p class="mr-4 lead ">3. To provide an academic background essential
                                        for higher professional and academic studies.</p>
                                </li>
                            </ul>
                    ...
                    <div class="border mb-4">
                        ...
                        <div class="p-4 border-top">
                            <span class="lead text-dark fw-6">The aim of Bangladesh Naval Academy is to prepare young men and women joining Bangladesh Navy as junior officers and leaders.</span>
                        </div>
                    </div>
                    <!-- end -->
