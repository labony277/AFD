...
<div class="page-title-area" style="    position: relative;
    ...
    color: #fff;
    text-align: center;
    text-shadow: 5px 4px 5px black;">OFFICERS’ TRAINING SCHOOL (OTS)</h2>
                </div>
            </div>
              ...
              <div class="carousel-inner">
                 <div class="carousel-item active" style="height:
                    ...
                    <img class="d-block w-100"
                       src="../assets/img/school/baf/5.OTS BAF/1. First Pic (Double Page).jpg"
                       alt="First slide">
                 </div>
                 <div class="carousel-item" style="height: 500px">
                    <img class="d-block w-100"
                       src="../assets/img/school/baf/5.OTS BAF/3 .jpg"
                       alt="Second slide">
                 </div>
                 <div class="carousel-item" style="height: 500px">
                    <img class="d-block w-100"
                       src="../assets/img/school/baf/5.OTS BAF/2-min.JPG"
                       alt="Third slide">
                 </div>
              </div>
           ...
           <div class="col-md-12 col-lg-12">
              <div class="border mb-4 desc_box">
                 ...
                 <div class="p-4 border-top">
                    <p class="mt-2 lead">Officers’ Training School (OTS) is one of the unique and oldest institutions of Bangladesh Air Force entrusted with the responsibility
                        of imparting Basic Professional, Elementary Admin and Intermediate Professional Training for all branch’s officers of BAF except
                        General Duties (Pilot), General Duties (Navigator), Air Traffic Controller (ATC) and Air Defence Weapon Controller (ADWC) branch. OTS
                        is engaged in skill enhancement, development of capacity and knowledge level of officers through basic professional training and
                        other effective training process.
                    </p>
                 </div>
              </div>
           </div>
           <div class="col-md-12 col-lg-8">
              <div class="border mb-4">
                 ...
                 <div class="p-4 border-top desc_box">
                    <span class="lead fw-6">Objectives of OTS are as follow:</span>
                    <ul class="list-unstyled mt-3">
                       ...
                       <li class="d-sm-flex align-items-center
                          border-bottom pb-3
                          mb-3">
                          <p class="mr-4 lead">2. To conduct refresher courses for engineering
                            branches officers.
                          </p>
                       </li>
                       <li class="d-sm-flex align-items-center
              ...
              <div class="border mb-4">
                 ...
                 <div class="p-4 border-top desc_box">
                    <span class="lead fw-6">To provide basic professional training for officers
                        of all the branches except GD (P), GD (N), ATC and
                        ADWC.</span>
                 </div>
              </div>
           </div>
                 ...
                 <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="tab_content desc_box">
                          ...
                          <div class="tabs_item" style="display:
                             none;">
                             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3667.6797573625468!2d89.14900381433729!3d23.181885416173728!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ff17106e912f5d%3A0xb724b10a5c08280!2sOfficers&#39;%20Training%20School!5e0!3m2!1sen!2sbd!4v1635147550055!5m2!1sen!2sbd" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                          </div>
                       </div>
                    </div>
                 </div>
                        ...
                        <div class="panel-body">
                           <table style="width:100%">
                              ...
                              <tr style="text-align: center;">
                                 ...
                                 <td>To impart basic professional training for improving
                                    professional skills.
                                 </td>
                                 <td>English</td>
                                 <td>Pilot Officer/
