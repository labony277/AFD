...
<div class="page-title-area" style="    position: relative;
    ...
    color: #fff;
    text-align: center;
    text-shadow: 5px 4px 5px black;">FIGHTER CONTROLLER TRAINING UNIT
                                     (FCTU)</h2>
                </div>
            </div>
           ...
           <div class="col-md-12 col-lg-12">
              <div class="border mb-4 desc_box">
                 ...
                 <div class="p-4 border-top">
                    <p class="mt-2 lead">Fighter Controller Training Unit was established in 1982. The unit has developed unique integrated training environment where
                        both officers and airmen are trained simultaneously, complementing each other towards achieving professional cohesion. The
                        training imparted by this unit includes Basic Air Defence Weapoin & Controller Course (ADWC) for BAF, overseas and sister service
                        officers including Trade Courses (Basic, Advance and Senior) for the Radar Operators.
                    </p>
                 </div>
              </div>
           </div>
           <div class="col-md-12 col-lg-8">
              <div class="border mb-4">
                 ...
                 <div class="p-4 border-top desc_box">
                    <span class="lead fw-6">Objectives of FCTU are as follow:</span>
                    <ul class="list-unstyled mt-3">
                       ...
                       <li class="d-sm-flex align-items-center
                          border-bottom pb-3
                          mb-3">
                          <p class="mr-4 lead">2. To conduct refresher course and continuation
              ...
              <div class="border mb-4">
                 ...
                 <div class="p-4 border-top desc_box">
                    <span class="lead fw-6">To provide professional training to BAF, overseas
                        ...
                        <div class="panel-body">
                           <table style="width:100%">
                              ...
                              <tr style="text-align: center;">
                                 ...
                                 <td>To impart professional knowledge to Officers.
                                 </td>
                                 <td>English</td>
                                 <td>Squadron
                                    Leader/
