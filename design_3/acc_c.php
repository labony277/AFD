...
<div class="page-title-area">
        ...
        <div class="row justify-content-center">
            <div class="col-1">
                <div class="logo" style="text-align: center">
                    <img src="assets/img/school/acc_and_c/logo-removebg-preview.png" alt="logo" style="max-width: 160px">
                </div>
            </div>
            <div class="col-10">
    ...
    color: #fff;
    text-align: center;
    text-shadow: 5px 4px 5px black;">ARMOURED CORPS CENTRE AND SCHOOL (ACC & S)</h2>
            </div>
        </div>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/acc_and_c/5..jpg" alt="First slide">
                        </div>
                        <div class="carousel-item" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/acc_and_c/1.jpeg" alt="Second slide">
                        </div>
                        <div class="carousel-item" style="height: 500px">
                            <img class="d-block w-100" src="assets/img/school/acc_and_c/4..JPG" alt="Third slide">
                        </div>
                    </div>
                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="border mb-4">
                        ...
                        <div class="p-4 border-top">
                            <p class="mt-2 lead">Armoured Corps Centre and School was raised on 01 October 1977 in Jahangirabad Cantonment, Bogura and started
                                its journey with School Wing and Training Squadron. For its brilliant achievements Armoured Corps Centre and School (ACC&S) was
                                awarded with coveted Regimental Colour on 26 April 1994 and National Standard on 25 April l994.</p>
                        </div>
                    </div>
                    <!-- end -->
                    ...
                    mb-3">
                                    ...
                                    <p class="mr-4 lead">1.To Train and educate young officers, Junior Commissioned Officers and Non-Commissioned officers of
                                        Armoured Corps on developing technical, tactical, administration and leadership skills required to perform as effective
                                        junior leaders, staff and instructors in Armoured Units in combined arms environment during war and peace.</p>
                    ...
                    mb-3">
                                    ...
                                    <p class="mr-4 lead">2. . To provide required knowledge and training to selected officers and Non-commissioned officers of
                                        Armoured Corps on advance technical matter in order to enable them as effective technical advisers at different levels
                                        and to enable them as instructors at Armoured Corps Centre and School.</p>
                                </li>
                                <li class="d-sm-flex align-items-center border-bottom pb-3
                    mb-3">

                                    <p class="mr-4 lead">3.o provide necessary technical and tactical training required for combined arms environment to
                                        officers, Junior Commissioned Officer and Other Ranks of Armoured Corps and Mechanized Forces.</p>
                                </li>
                    ...
                    <div class="border mb-4">
                        ...
                        <div class="p-4 border-top">
                            <span class="lead text-dark fw-6">To impart fundamental military training to the recruits as well as to impart basic and advance training to young officers, mid-level officers, Junior Commissioned Officers and Non-Commissioned officers of Armoured Corps and mechanized forces; and to carry out the function of Armoured Corps Records.</span>
                        </div>
                    </div>
                    <!-- end -->
